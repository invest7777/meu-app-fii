...
# --- DADOS REAIS DA SUA IMAGEM (SOMA: R$ 29.773,28) ---
# 'custo': Valor exato da imagem | 'qtd': Quantidade para o cálculo do valor de mercado
carteira_dados = {
    "MXRF11.SA": {"custo": 2001.24, "qtd": 204},
    "RECR11.SA": {"custo": 2090.66, "qtd": 26},
    "VGHF11.SA": {"custo": 3009.60, "qtd": 330},
    "VISC11.SA": {"custo": 2097.03, "qtd": 18},
    "XPML11.SA": {"custo": 3448.44, "qtd": 30},
    "BTCI11.SA": {"custo": 2008.10, "qtd": 205},
    "HGLG11.SA": {"custo": 5037.76, "qtd": 31},
    "KNCR11.SA": {"custo": 10080.45, "qtd": 98}
}
...
st.caption(f"Sincronizado com B3 Real-Time • {datetime.now().strftime('%d/%m/%Y %H:%M')}")
...
c3.metric("RESULTADO LÍQUIDO", f"R$ {p_l_total:,.2f}".replace(",", "X").replace(".", ",").replace("X", "."), 
...
with col_right:
    st.markdown("### 📋 Visão Detalhada de Performance")
...
st.markdown("---")
st.caption("⚠️ O Valor Investido baseia-se na sua imagem. O Valor Atual oscila conforme a última cotação da B3.")
